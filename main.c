...
static int menu(void) {
    ...
    printf("3. Rotation de matrice (a venir)\n");
    printf("4. Inversion de matrice (a venir)\n");
    printf("0. Quitter\n");
    printf("Votre choix: ");
    if (scanf("%d", &choix) != 1) {
        int c;
...
int main (void) {
    for (;;) {
        ...
        if (choix == 0) {
            ...
            printf("Multiplications de matrices 2D: A(lignes x colonnes) et B(lignes x colonnes)\n");
